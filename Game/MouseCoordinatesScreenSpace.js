// Import the necessary classes from the engine
import GameObject from "../Engine/GameObject.js";
import Text from "../Engine/Text.js";
import TextDraw from "../Engine/TextDraw.js";

// Define a new class for displaying the mouse coordinates in screen space
class MouseCoordinatesScreenSpace extends GameObject {
  ...
  // Attach a listener to the mousemove event to update the mouse position in screen space
  trackMouse() {
...
export default MouseCoordinatesScreenSpace;
