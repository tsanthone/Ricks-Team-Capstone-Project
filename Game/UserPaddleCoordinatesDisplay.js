...
class UserPaddleCoordinatesDisplay extends GameObject {
  // The constructor takes a userPaddle object as parameter
  constructor(userPaddle) {
  ...
  update() {
    ...
    textComponent.text = `User Paddle: (${this.userPaddle.x.toFixed(2)}, ${this.userPaddle.y.toFixed(2)})`;
...
export default UserPaddleCoordinatesDisplay;
