...
// Define a new class for displaying the mouse coordinates in camera space
class MouseCoordinatesCameraSpace extends GameObject {
  ...
  trackMouse() {
    document.addEventListener("mousemove", (event) => {
      ...
      this.mouseY = this.screenHeight / 2 - event.clientY;
    });
  }
...
export default MouseCoordinatesCameraSpace;
